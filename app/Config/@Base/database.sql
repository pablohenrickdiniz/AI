...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Jan-2015 às 02:23
...
CREATE TABLE IF NOT EXISTS `config` (
  ...
  PRIMARY KEY (`id`),
  KEY `last_project_id` (`last_project_id`)
...
--
ALTER TABLE `config`
ADD CONSTRAINT `config_ibfk_1` FOREIGN KEY (`last_project_id`) REFERENCES `project` (`id`);
