 ...
 */
	Configure::write('Security.salt', '+4X+=-9Wm_~%=Vt;|5:;*;=3J9|A+^4k!-~=!_4;%;!2~+:3=7;|!S76S59w');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '997907505421040540874331667400211203976418732888095640726568');
