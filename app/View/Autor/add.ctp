...
?>
    ...
    <h4 class="page-header"><b>Novo Autor</b></h4>
<?= $this->Form->create('Autor', array('inputDefaults' => array('class' => 'form-control', 'style' => 'border-radius:0', 'label' => false))) ?>
    ...
    <div class="form-group col-md-12">
        <?= $this->Form->input('Arquivo.arquivo', array('class' => 'form-control', 'type' => 'file', 'id' => 'foto', 'required', 'label' => 'Foto do autor')) ?>
    ...
    <div class="form-group col-md-12">
        <?= $this->Form->submit('Cadastrar', array('class' => 'btn btn-success', 'style' => 'border-radius:0;width:200px')) ?>
    </div>
<?= $this->Form->end() ?>