...
$(document).ready(function () {
    ...
    var mapManager = {
        ...
        createMap: function () {
            var self = this;
            if (!self.creating) {
                var name = $('#nome-mapa').val();
                var display_name = $('#nome-apresentacao').val();
                var altura = $('#mapa-altura').val();
                var largura = $('#mapa-largura').val();
                var loop = $('#mapa-loop').val();
            }
        }
    };
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="nome-apresentacao">Nome de Apresentação</label>
                                <input type="text" name="nome-apresentacao" id="nome-apresentacao" class="form-control"/>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="mapa-altura">Altura</label>
                                <input type="number" id="mapa-altura" name="mapa-altura" class="form-control" min="10" max="1000"
                                       value="10"/>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="mapa-largura">Largura</label>
                                <input type="number" id="mapa-largura" name="mapa-largura" class="form-control" min="10" max="1000"
                                       value="10"/>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="mapa-loop">Loop do Mapa</label>
                    ...
                    <div class="modal-footer">
                        <button id="create-map-action" type="submit" class="btn btn-default">Criar
                        </button>
                        <button id="cancel-new-map" type="button" class="btn btn-primary"  data-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </form>
        </div>
