...
<div class="table-responsive">
    <h4 class="page-header"><b>Novo Livro</b></h4>
    <?= $this->Form->create('Livro', array('inputDefaults' => array('class' => 'form-control', 'style' => 'border-radius:0','label' => false))) ?>
    <div class="row">
    ...
    <div class="row" style="margin-top:30px">
        <div class="form-group col-md-12">
            <?= $this->Form->submit('Cadastrar', array('class' => 'btn btn-success', 'style' => 'border-radius:0;width:200px','id' => 'submit')) ?>
        </div>
    </div>
    <?= $this->Form->end() ?>
</div>